...
export default function CADashboard() {
  ...
  function getScoreBadge(score: number) {
    if (score >= 80) return { label: 'Ready', color: 'bg-emerald-100 text-emerald-700' }
  ...
  const navItems = [
    ...
    { key: 'followups', icon: '🔔', label: 'Reminders' },
  ]
  ...
  return (
    <div className="flex h-screen overflow-hidden"
      ...
      {/* SIDEBAR */}
      <div className={`${sidebarOpen ? 'w-56' : 'w-16'} flex-shrink-0 flex flex-col transition-all duration-300 ease-in-out`}
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-emerald-700">
          {sidebarOpen && (
            <span className="text-white font-bold text-lg">CA<span className="text-emerald-300">Flow</span></span>
          )}
          <button
            onClick={() => setSidebarOpen(!sidebarOpen)}
            className="text-emerald-300 hover:text-white p-1 rounded-lg hover:bg-emerald-700 transition-colors ml-auto">
            {sidebarOpen ? '◀' : '▶'}
          </button>
        </div>
        ...
        {sidebarOpen && (
          <div className="px-4 py-3 border-b border-emerald-700">
            <p className="text-emerald-300 text-xs">Firm</p>
            <p className="text-white text-sm font-medium truncate">{firmName}</p>
          </div>
        )}
        ...
        <nav className="flex-1 px-2 py-4 space-y-1">
          ...
          <div className="pt-2 border-t border-emerald-700 mt-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-emerald-200 hover:bg-white/10 hover:text-white transition-all text-left">
              <span className="text-lg flex-shrink-0">🧾</span>
              {sidebarOpen && <span className="text-sm font-medium">Invoices</span>}
            </button>
            <button
        ...
        <div className="px-2 py-4 border-t border-emerald-700">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-emerald-300 hover:bg-white/10 hover:text-white transition-all text-left">
            <span className="text-lg flex-shrink-0">🚪</span>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white/70 backdrop-blur-md border-b border-white/50 px-6 py-3 flex items-center justify-between flex-shrink-0 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Avatar */}
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-emerald-400 to-blue-500 flex items-center justify-center text-white font-bold text-sm shadow-md cursor-pointer"
              onClick={() => router.push('/ca/profile')}>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-5">
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="rounded-2xl p-5 text-white shadow-lg shadow-emerald-200 hover:shadow-xl hover:-translate-y-0.5 transition-all"
                ...
                <div className="rounded-2xl p-5 text-white shadow-lg shadow-violet-200 hover:shadow-xl hover:-translate-y-0.5 transition-all"
                    ...
                    {clients.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {clients.map(client => {
                          ...
                          return (
                            <ClientDocRow key={client.id} client={client} clientDocs={clientDocs}
                              verified={verified} pending={pending} overdue={overdue}
                              pct={pct} score={score} badge={badge}
              ...
              {/* INVOICES SECTION */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-sm border border-white">
                <button onClick={() => setInvoicesExpanded(!invoicesExpanded)}
                  className="w-full flex items-center justify-between px-5 py-4 hover:bg-white/90 transition-colors">
                  <div className="flex items-center gap-3">
                ...
                {invoicesExpanded && (
                  <div className="border-t border-gray-100 px-5 py-4">
                    ...
                    <button onClick={() => router.push('/ca/invoices')}
                      className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm py-2.5 rounded-xl font-medium shadow-md shadow-blue-200 transition-all hover:from-blue-600 hover:to-blue-700">
                      Manage invoices →
                    </button>
                  </div>
                )}
              ...
              {/* PAYMENTS SECTION */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-sm border border-white">
                <button onClick={() => setPaymentsExpanded(!paymentsExpanded)}
                  className="w-full flex items-center justify-between px-5 py-4 hover:bg-white/90 transition-colors">
                  <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-5">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">{clients.length} clients total</p>
                </div>
              ...
              {clients.length === 0 ? (
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-12 text-center shadow-sm">
                  ...
                  <button onClick={() => router.push('/ca/add-client')}
                    className="bg-emerald-500 text-white text-sm px-4 py-2 rounded-xl hover:bg-emerald-600 shadow-md">
